use super::super::font_data::{FontData, GlyphData, GlyphPoint, GlyphTable};
use super::super::font_file::FontFile;
use super::glyph_flags::GlyphFlags;
...
pub fn parse_font(file: &mut FontFile) -> io::Result<FontData> {
    ...
    for _ in 0..num_tables {
        ...
        tables.insert(String::from_iter(table.tag.iter()), table);
    }
